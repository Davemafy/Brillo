...
function Courses() {
  ...
  return (
    <section className="p-8.25">
      <button className="bg-black text-white text-sm p-2 -y-4 rounded-2xl mb-4">Add course</button>
          ...
          return (
            ...
            >
              <header className="flex justify-between">
                <h2 className="truncate max-w-[10ch] sm:max-w-min">{course.title}</h2>
                <AwardIcon strokeWidth={"1"} />
              </header>
              <div className="flex items-end gap-4">
                <p className="text-[0.83rem] flex-1">{course.progress}% completed</p>
                <div
