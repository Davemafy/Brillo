...
function CoursePage() {
  ...
  const timeSpent = parseFloat(((course?.duration * course.progress) / 100).toFixed(1));
  ...
  const deleteCourse = async (courseId: string) => {
    ...
    if (error) {
      ...
      setNotes((notes) =>
        notes.filter((item) => item.course_id !== course.id),
      );
      router.invalidate();
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm min-h-100">
