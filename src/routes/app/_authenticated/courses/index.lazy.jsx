...
function Courses() {
  ...
  return (
    <>
      ...
      <section className="grid grid-dashboard   w-full h-full overflow-auto gap-8 p-5 sm:p-0 sm:px-2">
        <section
          id="target"
              ...
              <div className="flex mb-4 justify-between">
                ...
                <div className="flex items-center gap-10 fixed sm:static bottom-4 z-2 sm:bottom-0 right-6 justify-between">
                  <button
                    ...
                    className="bg-dark text-x h-full  flex justify-center items-center justify-between gap-1 font-medium p-2 w-22 text-white text-sm rounded-xl"
                  >
